...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chatContainer = QFrame(self.centralwidget)
        self.chatContainer.setObjectName(u"chatContainer")
        self.chatContainer.setGeometry(QRect(179, 430, 591, 61))
        self.chatContainer.setFrameShape(QFrame.Shape.StyledPanel)
        self.chatContainer.setFrameShadow(QFrame.Shadow.Raised)
